...
client = genai.Client(api_key="AIzaSyBMQzWLHcTOTNzDHQoCB-rD0B2x558RyrA")
...
def filter_and_summarize_articles(articles):
    prompt = f"Filter the top three most reliable medical articles from this list and summarize them in 5 lines. Only return the summaries and URLs:\n{articles}"
